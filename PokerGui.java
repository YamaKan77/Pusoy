...
public class PokerGui extends JPanel {
    ...
    private class CardPanel extends JPanel implements ActionListener {
        ...
        Hand hand1;       // The cards that have been dealt.
        Hand hand2;
        Hand hand3;
        Hand hand4;
        ...
        void doHigher() {
            ...
            hand1.addCard( deck.dealCard() );     // Deal a card to the hand.
            int cardCt = hand1.getSize();
            Card thisCard = hand1.hand.get( cardCt - 1 );  // Card just dealt.
            Card prevCard = hand1.hand.get( cardCt - 2 );  // The previous card.
        ...
        void doNewGame() {
            ...
            hand1 = new Hand();
            deck.shuffle();
            hand1.addCard( deck.dealCard() );  // Deal the first card into the hand.
        ...
        public void paintComponent(Graphics g) {
            ...
            for (int i = 0; i < cardCt; i++)
                drawCard(g, hand1.hand.get(i), 10 + i * 90, 10);
            if (gameInProgress)
